				...
				<div className="flex flex-col gap-4 p-4">
						...
						<div className="flex gap-x-2 md:w-7/12">
							...
							<div className="w-full">
								<h6 className="mb-1 font-semibold md:max-w-[75%]">
									JavaScript Fundamentals: Variables and Data
									Types
								</h6>
								...
								<p className="mt-2 hidden text-sm md:block">
									...
									variables, data types, and how to use them
									in your programs.
								</p>
							</div>
						</div>
					...
					<div className="w-full max-w-3xl gap-x-4 md:flex">
						...
						<div className="flex gap-x-2 md:w-7/12">
							...
							<div className="w-full">
								...
								<p className="mt-2 hidden text-sm md:block">
									Learn the basics of building web
					...
					<div className="w-full max-w-3xl gap-x-4 md:flex">
						...
						<div className="flex gap-x-2 md:w-7/12">
							...
							<div className="w-full">
								<h6 className="mb-1 font-semibold md:max-w-[75%]">
									Building a RESTful API with Node.js and
									Express
								</h6>
								<p className="flex text-sm text-gray-200 sm:mt-3">
								...
								<p className="mt-2 hidden text-sm md:block">
									Learn how to create a RESTful API using
									Node.js and the Express framework for
					...
					<div className="w-full max-w-3xl gap-x-4 md:flex">
						...
						<div className="flex gap-x-2 md:w-7/12">
							...
							<div className="w-full">
								...
								<p className="mt-2 hidden text-sm md:block">
									Discover how to build mobile applications
					...
					<div className="w-full max-w-3xl gap-x-4 md:flex">
						...
						<div className="flex gap-x-2 md:w-7/12">
							...
							<div className="w-full">
								...
								<p className="mt-2 hidden text-sm md:block">
									Learn how to create and use custom hooks to
									share logic across multiple React
									components.
								</p>
							</div>
						</div>
					...
					<div className="w-full max-w-3xl gap-x-4 md:flex">
						...
						<div className="flex gap-x-2 md:w-7/12">
							...
							<div className="w-full">
								...
								<p className="mt-2 hidden text-sm md:block">
									Learn how to build robust and scalable web
									applications using the Django framework for
									Python.
								</p>
							</div>
						</div>
						...
						<div className="flex gap-x-2 md:w-7/12">
							...
							<div className="w-full">
								...
								<p className="mt-2 hidden text-sm md:block">
									...
									user interfaces with React and the D3.js
						...
						<div className="flex gap-x-2 md:w-7/12">
							...
							<div className="w-full">
								...
								<p className="mt-2 hidden text-sm md:block">
									...
									in Node.js applications using the
						...
						<div className="flex gap-x-2 md:w-7/12">
							...
							<div className="w-full">
								...
								<p className="mt-2 hidden text-sm md:block">
									...
									and dashboards using Tableau for data
									analysis.
								</p>
							</div>
						</div>
						...
						<div className="flex gap-x-2 md:w-7/12">
							...
							<div className="w-full">
								...
								<p className="mt-2 hidden text-sm md:block">
									...
									using Socket.IO for seamless communication
					...
					<div className="w-full max-w-3xl gap-x-4 md:flex">
						...
						<div className="flex gap-x-2 md:w-7/12">
							...
							<div className="w-full">
								...
								<p className="mt-2 hidden text-sm md:block">
									Learn how to create captivating animations
									and transitions using CSS for dynamic web
									experiences.
								</p>
							</div>
						</div>
					...
					<div className="w-full max-w-3xl gap-x-4 md:flex">
						...
						<div className="flex gap-x-2 md:w-7/12">
							...
							<div className="w-full">
								...
								<p className="mt-2 hidden text-sm md:block">
									Explore advanced patterns and techniques for
									building scalable and maintainable React
									applications.
								</p>
							</div>
						</div>
...
export default VideoListingListView;
